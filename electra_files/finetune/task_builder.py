...
from electra_files.finetune.qa import qa_tasks
from electra_files.model import tokenization


def get_tasks(config: electra_files.configure_finetuning.FinetuningConfig):
...
def get_task(config: electra_files.configure_finetuning.FinetuningConfig, task_name,
             tokenizer):
