...
from electra_files.finetune import feature_spec
from electra_files.finetune import task
from electra_files.finetune.qa import qa_metrics
...
class QATask(task.Task):
    ...
    def __init__(self, config: electra_files.configure_finetuning.FinetuningConfig, name,
                 tokenizer, v2=False):
...
class SQuAD(SQuADTask):
    def __init__(self, config: electra_files.configure_finetuning.FinetuningConfig, tokenizer):
