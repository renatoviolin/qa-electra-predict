...
from electra_files.finetune import scorer
# from electra_files.finetune.qa import squad_official_eval
# from electra_files.finetune.qa import squad_official_eval_v1
...
class SpanBasedQAScorer(scorer.Scorer):
    ...
    def __init__(self, config: electra_files.configure_finetuning.FinetuningConfig, task, split,
                 v2):
...
def get_final_text(config: electra_files.configure_finetuning.FinetuningConfig, pred_text,
                   orig_text):
